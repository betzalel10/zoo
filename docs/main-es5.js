(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.getUp = function (ev) {
                    ...
                    switch (this.paging.currentPanel) {
                        case 'birds':
                            var newBirdIndex = this.getNewCuurentIndex(this.birds.currentBirdIndex, ev, this.birds.birds);
                            this.birds.currentBirdIndex = newBirdIndex;
                            this.birds.currentBird = this.birds.birds[newBirdIndex];
                            break;
                        case 'farm animals':
                            var newBeastIndex = this.getNewCuurentIndex(this.beasts.currentBeastIndex, ev, this.beasts.beasts);
                            this.beasts.currentBeastIndex = newBeastIndex;
                            this.beasts.currentBeast = this.beasts.beasts[newBeastIndex];
                            break;
                        case 'wild animals':
                            var newWildIndex = this.getNewCuurentIndex(this.wilds.currentWildIndex, ev, this.wilds.wilds);
                ...
                AppComponent.prototype.getNewCuurentIndex = function (current, delta, array) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BeastCardComponent = /** @class */ (function () {
                function BeastCardComponent(beastSvc) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BirdCardComponent = /** @class */ (function () {
                function BirdCardComponent(birdSvc) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NevigationComponent = /** @class */ (function () {
                function NevigationComponent(paging) {
                    this.paging = paging;
                }
                NevigationComponent.prototype.ngOnInit = function () {
                };
                NevigationComponent.prototype.navTo = function (pagename) {
                    console.log("navTo( " + pagename + " )");
                    this.paging.currentPanel = pagename;
                };
                return NevigationComponent;
            }());
            NevigationComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PaginatorComponent = /** @class */ (function () {
                ...
                PaginatorComponent.prototype.moveNextItem = function (delta) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BeastsPanelComponent = /** @class */ (function () {
                function BeastsPanelComponent(beastSvc) {
                    this.beastSvc = beastSvc;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BirdsPanelComponent = /** @class */ (function () {
                function BirdsPanelComponent(birdSvc) {
                    this.birdSvc = birdSvc;
                }
            ...
            var BeastsService = /** @class */ (function () {
                function BeastsService(http) {
                    ...
                    http.get('https://raw.githubusercontent.com/betzalel10/zoo/master/docs/src/assets/beast.json')
                        ...
                        _this.beasts = data;
                        _this.currentBeast = _this.beasts[0];
                    });
                }
                return BeastsService;
            }());
            BeastsService.ctorParameters = function () { return [
            ...
            var BirdService = /** @class */ (function () {
                function BirdService(http) {
                    ...
                    http.get('https://raw.githubusercontent.com/betzalel10/zoo/master/docs/src/assets/bird.json')
                        .subscribe(function (data) {
                        _this.birds = data;
                        _this.currentBird = _this.birds[0];
                    });
                }
                return BirdService;
            }());
            BirdService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
